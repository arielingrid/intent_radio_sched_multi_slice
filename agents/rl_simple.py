...
class PIAgent(Agent):
    ...
    def init_agent(self) -> None:
        self.agent = PIAgentTrain(
            '/home/lasse_rtx/Repos2/intent_radio_sched_multi_slice/agents/sched_pi.gin',
            '/home/lasse_rtx/Repos2/intent_radio_sched_multi_slice/output',
            None,
            seed=self.seed,
        )

    def step(self, obs_space: Optional[Union[np.ndarray, dict]]) -> np.ndarray:
        raise NotImplementedError("PIAgent does not implement step()")
